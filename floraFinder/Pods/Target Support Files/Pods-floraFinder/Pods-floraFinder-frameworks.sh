...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DeclarativeLayoutKit/DeclarativeLayoutKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Differentiator/Differentiator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FunctionalNavigationFlowKit/FunctionalNavigationFlowKit.framework"
